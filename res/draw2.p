...
set title "Power consumption of critical units by task lu of class B with 8 cores (MPI)"
...
plot\
	...
	"OMP/lu.B.8.power.txt" u 0:3 t "OpenMP_8_cores" with line,\
...
plot\
	"MPI/lu.B.1.power.txt" u 0:(sum1=sum1+$3) t "1 core" with line,\
	"MPI/lu.B.2.power.txt" u 0:(sum2=sum2+$3) t "2 cores" with line,\
	"MPI/lu.B.4.power.txt" u 0:(sum4=sum4+$3) t "4 cores" with line,\
	"MPI/lu.B.8.power.txt" u 0:(sum8=sum8+$3) t "8 cores" with line;
...
plot\
	"MPI/lu.B.8.power.txt" u 0:(sum2=sum2+$3) t "lu_8_cores",\
	"MPI/lu.B.4.power.txt" u 0:(sum1=sum1+$3) t "lu_4_cores",\
	"MPI/cg.B.8.power.txt" u 0:(sum8=sum8+$3) t "cg_8_cores",\
	"MPI/cg.B.4.power.txt" u 0:(sum4=sum4+$3) t "cg_4_cores";
...
plot\
	"MPI/lu.B.8.power.txt" u 0:(sum8=sum8+$3) t "MPI_8_cores",\
	"MPI/lu.B.4.power.txt" u 0:(sum4=sum4+$3) t "MPI_4_cores",\
	"OMP/lu.B.8.power.txt" u 0:(sum2=sum2+$3) t "OpenMP_8_cores",\
	"OMP/lu.B.4.power.txt" u 0:(sum1=sum1+$3) t "OpenMP_4_cores";


set title "Processing units' temperature monitoring on running lu class B with 8 cores (MPI)"
set xlabel "Timestamp (s)"
...
set title "Processing units' temperature monitoring on running lu class B with 8 cores (OpenMP)"
