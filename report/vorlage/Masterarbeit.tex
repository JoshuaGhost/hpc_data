...
\newcommand{\firstprof}{Prof. Dr.-Ing. G. von Voigt}
\newcommand{\secondprof}{Prof. Dr. rer. nat. M. Smith}
\newcommand{\betreuer}{Dipl.-Inform. H. Tobaben}
\date{\today}
\newcommand{\art}{Masterarbeit}  % Bachelorarbeit / Diplomarbeit / Studienarbeit
\newcommand{\studiengang}{Informatik (M.Sc.)}
\newcommand{\keywords}{Security,Masterarbeit,Wichtig,Test}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
